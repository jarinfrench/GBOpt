...
class MonteCarloMinimizer:
    ...
    def run_MC(self, E_accept: float = 1e-1, min_steps: int = None, max_steps: int = 50, E_tol: float = 1e-4, max_rejections: int = 20, cooldown_rate: float = 1.0, unique_id: int = uuid.uuid4(), *, checkpoint_file: str | Path | None = None, checkpoint_format: str = "json", checkpoint_interval: int = 1, **kwargs) -> float:
        ...
        :param min_steps: Sets the minimum number of iteratiosn of MC that are run. Defaults to None
